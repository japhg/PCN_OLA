...
{
    $token = $_GET['token'];
    $query = "SELECT verify_token, verify_status FROM hr1_applicant WHERE verify_token = '$token' LIMIT 1";
    ...
    if(mysqli_num_rows($result) > 0)
    {
        ...
        if($row['verify_status'] == "0")
        {
            ...
            $update_query = "UPDATE hr1_applicant SET verify_status = '1' WHERE verify_token = '$clicked_token' LIMIT 1";
