...
function send_email($email)
{
	...
	$query = "insert into hr1_codes (email_address,code,expire) value ('$email','$code','$expire')";
...
function save_password($pass)
{
	...
	$query = "update hr1_applicant set password = '$passHashed' where email_address = '$email' limit 1";
	mysqli_query($con, $query);
}
...
function valid_email($email)
{
	...
	$query = "select * from hr1_applicant where email_address = '$email' limit 1";
...
function is_code_correct($code)
{
	...
	$query = "select * from hr1_codes where code = '$code' && email_address = '$email' order by id desc limit 1";
	$result = mysqli_query($con, $query);
	if ($result) {
		if (mysqli_num_rows($result) > 0) {
